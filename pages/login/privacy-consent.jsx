...
import { useSendWhatsappMutation } from "../../services/auth.service";
...
export default function PrivacyConsent() {
  ...
  const handleLanjut = () => {
    if (router.query.phone) {
      ...
      router.push("otp", undefined, { shallow: true });
    }
  };
      ...
      <div className={styles.right_content_inner}>
        ...
        <div className="flex items-center mt-12">
          <input
            ...
            onChange={(event) => setIsRead(event.target.checked ? true : false)}
          />
          <label
